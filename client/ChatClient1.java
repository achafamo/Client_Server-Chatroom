...
public class ChatClient1 extends AbstractClient
{
  ...
  String myId;
  String joinedChannel = "UNIVERSAL";
...
//      System.out.println("executing login command on client side");
  ...
  public void sendMessageToChannel(String message, String channelName)
  {
    ...
    {
      //needs work
      //ServerChannelMessageHandler mess = new ServerChannelMessageHandler(message, channelName);
      try
      {
        sendToServer(message);
      }
  ...
  private void createAndDoCommand(String message)
  {
    ...
    try
    {
      ...
      //System.out.println("login.docommand client side");
      cmd.doCommand();
    }
    catch(Exception ex)
    {
